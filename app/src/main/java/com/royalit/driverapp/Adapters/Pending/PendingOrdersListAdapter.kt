package com.royalit.driverapp.Adapters.Pending
...
class PendingOrdersListAdapter (private val context: Context,
                                private val items: List<OrderHistoryResponse>,
                                private val onItemClick: (OrderHistoryResponse) -> Unit // Click listener function
) : RecyclerView.Adapter<PendingOrdersListAdapter.ItemViewHolder>() {
...
//            .into(holder.image)
        ...
        //order status
        holder.txtOrderStatus.setTextColor(ContextCompat.getColor(holder.itemView.context, R.color.red))
