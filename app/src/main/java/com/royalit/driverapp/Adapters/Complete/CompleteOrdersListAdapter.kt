package com.royalit.driverapp.Adapters.Complete
...
class CompleteOrdersListAdapter (private val context: Context,
                                 private val items: List<OrderHistoryResponse>,
                                 private val onItemClick: (OrderHistoryResponse) -> Unit // Click listener function
) : RecyclerView.Adapter<CompleteOrdersListAdapter.ItemViewHolder>() {
